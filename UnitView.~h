...
public:		// User declarations
    ...
    int       MouseOperation,
              LastMousePos[2],
              numTri,                   //Número de triangulos de la sala
              durSim,                   //Duración de la simulación
              numRec;                   //Número de receptores
    double    tiempo,                   //Tiempo para animación
              distancia;                //Distancia recorrida para animación
    bool      cuartoCargado,            //Si se carga la sala
              simularPropagacion,       //Si se realiza la simulación
              verRecorrido,             //Si se desea visualizar los rayos
              verTriangulos;            //Si se desea visualizar los triángulos
    room      r;                        //Sala cúbica
    source    s;                        //Fuente sonora
    receptor  r1;                       //Receptor acústico / Micrófono
    reflection *ry;                     //Resultado del trazado de rayos
    matDouble matAnguloS;               //Matriz con las distancias entre triángulos
    matDouble matDistancia;             //Matriz con las distancias entre triángulos
    matInt matTiempoV;                  //Matriz con el tiempo de vuelo entre triángulos
