...
struct reflection { //Respuesta al proceso de trazado de rayos.
    ...
    int idTriangle[MaxNPoints];             //Id único del triángulo por cuarto donde se chocó
    int Plane[MaxNPoints];                  //Nro. del plano por cuarto donde se chocó
    int Triangle[MaxNPoints];               //Nro. del triángulo por plano donde se chocó
